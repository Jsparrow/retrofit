  ...
  @Rule public final MockWebServer server = new MockWebServer();
	...
	@Test public void unsupportedRequestTypesNotMatched() {
	    try {
	      ...
	      assertThat(e).hasMessage(new StringBuilder().append("").append("Unable to create @Body converter for class java.lang.Object (parameter #1)\n").append("    for method Service.object").toString());
	      assertThat(e.getCause()).hasMessage(new StringBuilder().append("").append("Could not locate RequestBody converter for class java.lang.Object.\n").append("  Tried:\n").append("   * retrofit2.BuiltInConverters\n").append("   * retrofit2.converter.scalars.ScalarsConverterFactory\n").append("   * retrofit2.OptionalConverterFactory").toString());
	    }
	  }
	...
	@Test public void unsupportedResponseTypesNotMatched() {
	    try {
	      ...
	      assertThat(e).hasMessage(new StringBuilder().append("").append("Unable to create converter for class java.lang.Object\n").append("    for method Service.object").toString());
	      assertThat(e.getCause()).hasMessage(new StringBuilder().append("").append("Could not locate ResponseBody converter for class java.lang.Object.\n").append("  Tried:\n").append("   * retrofit2.BuiltInConverters\n").append("   * retrofit2.converter.scalars.ScalarsConverterFactory\n").append("   * retrofit2.OptionalConverterFactory").toString());
	    }
	  }
