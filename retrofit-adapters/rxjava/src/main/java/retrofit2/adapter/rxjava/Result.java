...
public final class Result<T> {
  private final @Nullable Response<T> response;
	...
	@Override public String toString() {
	    if (error != null) {
	      return new StringBuilder().append("Result{isError=true, error=\"").append(error).append("\"}").toString();
	    }
	    return new StringBuilder().append("Result{isError=false, response=").append(response).append('}').toString();
	  }
}
