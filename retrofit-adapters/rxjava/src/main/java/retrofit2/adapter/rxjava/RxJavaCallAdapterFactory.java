  ...
  private final @Nullable Scheduler scheduler;
	...
	@Override public @Nullable CallAdapter<?, ?> get(
	    ...
	    if (!(returnType instanceof ParameterizedType)) {
	      ...
	      throw new IllegalStateException(new StringBuilder().append(name).append(" return type must be parameterized").append(" as ").append(name).append("<Foo> or ").append(name).append("<? extends Foo>")
				.toString());
	    }
